                  ...
                  <div style={{ padding: "1rem 0" }}>
                    {selectedTab === 0 && (
                      <div>
                        <TextField
                          ...
                          onChange={(value) =>
                            handleFieldChange("countryList", value)
                          }
                          multiline={4}
                          autoComplete="off"
                        ...
                        />
                        <p>
                          Enter ISO country codes (Alpha-2 code) separated by
                          commas (e.g., US, CA, GB, DE)
                        </p>
                        <a
                    ...
                    {selectedTab === 1 && (
                      <TextField
                        ...
                        onChange={(value) =>
                          handleFieldChange("blockedIpAddresses", value)
                        }
                        multiline={4}
                        autoComplete="off"
                        ...
                        helpText={
                          <Text as="span" variant="bodyMd">
                            ...
                            <br />
                            Multiple IPs: Separate with commas, e.g.
                            192.168.1.1, 10.0.0.5
                            <br />
                            Use wildcards (*) to block or allow ranges, e.g.
                            10.0.*.*
                          </Text>
                        }
                      />
            ...
            <Card>
              <BlockStack gap="300">
                ...
                <TextField
                  ...
                  onChange={(value) =>
                    handleFieldChange("blockPageTitle", value)
                  }
                  maxLength={100}
                  autoComplete="off"
                  showCharacterCount
                ...
                <TextField
                  ...
                  onChange={(value) =>
                    handleFieldChange("blockPageDescription", value)
                  }
                  maxLength={500}
                  multiline={4}
                  autoComplete="off"
                ...
                <FormLayout>
                  ...
                  <FormLayout.Group condensed>
                    <TextField
                      ...
                      onChange={(value) =>
                        handleFieldChange("boxBackgroundColor", value)
                      }
                      autoComplete="off"
                      maxLength={100}
                      showCharacterCount
                ...
                <Text variant="bodyMd" as="p" tone="subdued">
                  Upload a logo image (max 1MB). Supported formats: .gif, .jpg,
                  .jpeg, .png, .svg
                </Text>
