...
INSERT INTO "new_CountryBlockerSettings" ("backgroundColor", "blockPageDescription", "blockPageTitle", "blockingMode", "boxBackgroundColor", "countryList", "createdAt", "id", "logoUrl", "shop", "textColor", "updatedAt") SELECT "backgroundColor", "blockPageDescription", "blockPageTitle", "blockingMode", "boxBackgroundColor", "countryList", "createdAt", "id", "logoUrl", "shop", "textColor", "updatedAt" FROM "CountryBlockerSettings";
